...
public class DuckbillParser {
    ...
    public void parse(final char[] xmlChars, final int length, IContentHandler handler) throws Exception {
        ...
        while (r.XmlOffset < length) {
            ...
            if (r.skipChar('<')) {
                ...
                if (r.skipChar('/')) {
                    ...
                    r.skipTagName();
                    final String tagName = new String(r.XmlDoc, tagNameStart, r.XmlOffset - tagNameStart);
                    final FB2Tag tag = FB2Tag.getTagByName(tagName);
                ...
                if (r.XmlDoc[r.XmlOffset] == '&') {
                    r.push();
                    if (r.skipTo(';')) {
                        int endOfEntity = r.XmlOffset;
                        r.pop();
                        int startOfEntity = r.XmlOffset;

                        char entity = (char) -1;
                        String string = new String(r.XmlDoc, r.XmlOffset + 1, endOfEntity - r.XmlOffset - 1);
