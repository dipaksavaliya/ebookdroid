...
public final class Rule {
     ...
     * 
     * @param selector
     *            A selector that the rule should initial with.
     */
     ...
     * 
     * @param selectors
     *            A list of selectors that the rule should initial with.
     */
     ...
     * 
     * @param propertyValue
     *            The property value that should be attached.
     */
     ...
     * 
     * @param selectors
     *            A list of selectors that should be appended.
     */
     ...
     * 
     * @param propertyValue
     *            The property value that should be removed.
     */
     ...
     * 
     * @param selector
     *            The selector that should be attached to the rule.
     */
